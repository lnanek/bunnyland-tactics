...
public class Marker {
	...
	public static final Marker[] ALL_MARKERS = new Marker[] {
		new Marker("piece_player1_warren.jpg", Player.ONE, 1),
		...
		new Marker("piece_player2_warrior.png", Player.TWO, 1),
		new Marker("tile_flowers_1.jpg", null, null),
		new Marker("tile_flowers_2.jpg", null, null),
		new Marker("tile_grass.jpg", null, null),
		new Marker("tile_rocks.jpg", null, null),
		new Marker("tile_trees.jpg", null, null),
	...
	/*
	public static Marker[] getPalletteForPlayer(Player player) {
		return player == Player.ONE ? NON_P2_MARKERS : NON_P1_MARKERS;
	}
	*/
}
