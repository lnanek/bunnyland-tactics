...
public class GameScreenDropController extends SimpleDropController {
	...
	private final GameScreenController module;

	public GameScreenDropController(TableCellPanel dropTarget, GameScreenController module) {
		super(dropTarget);
	...
	public void onDrop(DragContext context) {
		...
		module.moveMarker(source.getRow(), source.getColumn(), dropTarget.getRow(), dropTarget.getColumn(),
				draggedImage.getUrl());
	...
	public void onPreviewDrop(DragContext context) throws VetoDragException {
		...
		if (sourceIsPalette) {
			...
			// something?
			module.moveMarker(null, null, dropTarget.getRow(), dropTarget.getColumn(), draggedImage.getUrl());
