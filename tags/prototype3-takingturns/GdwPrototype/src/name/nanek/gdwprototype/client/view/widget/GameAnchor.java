...
public class GameAnchor {
	 ...
	 */
	public static String generateAnchor(GameListingInfo listing) {
		return GAME_LISTING_ANCHOR_PREFIX + listing.getId() + GAME_LISTING_ANCHOR_SEPERATOR + listing.getLinkName();
	}
